var mainApp = angular.module('app', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ui.router']);
...
var HeaderController = (function () {
    function HeaderController(state, storeFactory, chainFactory) {
        this.state = state;
        this.storeFactory = storeFactory;
        this.chainFactory = chainFactory;
    }
    HeaderController.prototype.goHome = function () {
        this.state.go('addItems');
        this.storeFactory.clearData();
        this.chainFactory.clearData();
    };
    ;
    HeaderController.$inject = ['$state', 'storeFactory', 'chainFactory'];
    return HeaderController;
}());
mainApp.controller('headerController', HeaderController);
var ResultController = (function () {
    function ResultController(arrayFactory, storeFactory, chainFactory, log) {
    ...
    ResultController.prototype.SetClass = function (bool) {
        if (bool) {
            return "cheapest";
        }
        else {
    ...
    ResultController.prototype.SetContainerClass = function (bool) {
        if (bool) {
    ...
    ResultController.prototype.GetStores = function () {
        return this.storeFactory.getStores();
    };
    ResultController.prototype.CheckPrice = function (data, price) {
    ...
    ResultController.prototype.GetData = function () {
    ...
    ResultController.$inject = ['arrayFactory', 'storeFactory', 'chainFactory', '$log'];
